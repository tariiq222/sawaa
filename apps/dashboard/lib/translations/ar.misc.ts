...
export const arMisc: Record<string, string> = {
  ...
  // — Executive Summary —
  "reports.summary.label": "ملخص الفترة",
  ...
  // Payment methods (used in revenue byMethod breakdown)
  "reports.paymentMethod.CARD": "بطاقة ائتمان",
  "reports.paymentMethod.BANK_TRANSFER": "تحويل بنكي",
  "reports.paymentMethod.CASH": "دفع نقدي",
  "reports.paymentMethod.mada": "مدى",
  "reports.paymentMethod.apple_pay": "Apple Pay",
  "reports.paymentMethod.unknown": "أخرى",
  // Revenue tab
  "reports.revenue.byMethod": "حسب طريقة الدفع",
  "reports.revenue.overview": "نظرة عامة",
  "reports.revenue.method": "الطريقة",
  "reports.revenue.amount": "المبلغ",
  "reports.revenue.count": "عدد الحجوزات",
  "reports.revenue.noPayments": "لا توجد بيانات مدفوعات لهذه الفترة",
