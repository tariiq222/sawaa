...
export const enMisc: Record<string, string> = {
  ...
  "detail.invoice.vat": "VAT",
  "detail.invoice.total": "Total",
  "detail.invoice.paid": "Paid",
  "detail.invoice.outstanding": "Outstanding",
  "detail.invoice.status": "Invoice status",
  "detail.invoice.empty": "No invoice for this booking yet.",
