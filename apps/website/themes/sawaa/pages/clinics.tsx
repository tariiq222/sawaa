      ...
      <div className="max-w-[1260px] mx-auto px-5 sm:px-6 md:px-8">
        <div className="grid md:grid-cols-12 gap-8 md:gap-12 items-end">
          ...
          <div className="md:col-span-5 lg:col-span-4 lg:col-start-9">
            <p
              ...
              style={{ color: 'var(--sw-body)', maxWidth: '38ch' }}
            >
              {t('clinics.lead')}
            </p>
          </div>
        ...
        >
          <Stat
            ...
            label={t('clinics.statTotal')}
          />
          <Stat
            value={String(totalTherapists).padStart(2, '0')}
            label={t('clinics.statTherapists')}
            withDivider
          />
          <Stat
    ...
    return (
      <div className="flex justify-center mt-8">
        ...
        >
          ...
          >
            <Building2 className="w-6 h-6" style={{ color: 'var(--sw-primary-600)' }} />
          </div>
          <h3
...
function Meter({ value, label }: { value: number; label: string }) {
  return (
    <div className="flex flex-col gap-0.5">
      <span
        className="text-[1.25rem] font-extrabold tabular-nums leading-none"
        style={{ color: 'var(--sw-secondary-700)' }}
      >
