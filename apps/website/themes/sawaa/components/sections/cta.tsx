...
export async function CTA() {
  ...
  return (
    <section id="cta" className="sw-home-cta px-5 sm:px-6 md:px-8 py-20 md:py-24">
      <div className="max-w-[1260px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-5">
        <AnimatedSection>
          <div
            className="sw-home-cta-booking relative h-full min-h-[168px] rounded-[28px] p-8 overflow-hidden flex flex-col justify-between"
          >
            <div className="relative z-10 flex items-start gap-4">
              <div className="sw-home-cta-icon w-12 h-12 rounded-2xl bg-white/20 backdrop-blur flex items-center justify-center shrink-0">
              ...
              <div className="flex-1">
                ...
                <p className="text-[0.813rem] text-white leading-snug">
                  {t('cta.subtitle')}
                </p>
              </div>
            </div>
            <div className="relative z-10 flex items-center justify-between gap-3 mt-5 pt-5 border-t border-white/15">
              <div className="flex items-center gap-2 text-[0.688rem] text-white font-semibold">
              ...
              <Link
                href="/booking"
                className="inline-flex items-center gap-1.5 bg-white font-extrabold text-[0.813rem] px-5 py-2.5 rounded-full hover:-translate-y-0.5 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--sw-home-sand)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--sw-home-deep-green)]"
                style={{
        ...
        <AnimatedSection delay={100}>
          <div
            className="sw-home-cta-app relative h-full min-h-[168px] rounded-[28px] p-8 overflow-hidden flex flex-col justify-between"
          >
            <div className="relative z-10 flex items-start gap-4">
              <div
