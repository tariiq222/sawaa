...
export function ProgramFormCapacity({ form }: { form: UseFormReturn<CreateProgramFormValues> }) {
  return (
    <div className="grid gap-4 md:grid-cols-4">
      ...
      <label className="block">
        <span className="mb-1 block text-sm font-medium">Hours / day</span>
        <Input type="number" min={1} {...form.register('hoursPerDay', { valueAsNumber: true })} />
      </label>
      <label className="block">
        <span className="mb-1 block text-sm font-medium">Min participants</span>
      ...
      <label className="block">
        <span className="mb-1 block text-sm font-medium">Max participants</span>
