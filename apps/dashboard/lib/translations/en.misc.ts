...
export const enMisc: Record<string, string> = {
  ...
  // — Executive Summary —
  "reports.summary.label": "Period Summary",
  ...
  // Payment methods
  "reports.paymentMethod.CARD": "Credit Card",
  ...
  "reports.revenue.overview": "Overview",
  "reports.revenue.method": "Method",
  "reports.revenue.amount": "Amount",
  "reports.revenue.count": "Bookings",
  "reports.revenue.noPayments": "No payment data for this period",
