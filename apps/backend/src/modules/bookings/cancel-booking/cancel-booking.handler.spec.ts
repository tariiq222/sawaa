...
describe('CancelBookingHandler', () => {
  it('cancels PENDING booking and emits event', async () => {
    ...
    const result = await new CancelBookingHandler(prisma as never, buildRlsTx(prisma) as never, buildTenant() as never, eb as never, defaultCancelSettings as never, buildZoom() as never, refundHandler as never).execute({
  ...
  it('throws NotFoundException when booking not found', async () => {
    ...
    await expect(
      new CancelBookingHandler(prisma as never, buildRlsTx(prisma) as never, buildTenant() as never, buildEventBus() as never, defaultCancelSettings as never, buildZoom() as never, refundHandler as never).execute({
...
describe('CancelBookingHandler — status log', () => {
  it('writes a BookingStatusLog entry on cancel', async () => {
    ...
    const handler = new CancelBookingHandler(prisma as never, buildRlsTx(prisma) as never, buildTenant() as never, eventBus as never, defaultCancelSettings as never, buildZoom() as never, refundHandler as never);
...
describe('CancelBookingHandler — free cancel window', () => {
  it('attaches freeCancelRefundType when cancelling within free window', async () => {
    ...
    const handler = new CancelBookingHandler(prisma as never, buildRlsTx(prisma) as never, buildTenant() as never, eventBus as never, settingsHandler as never, buildZoom() as never, refundHandler as never);
