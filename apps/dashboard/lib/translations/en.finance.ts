...
export const enFinance: Record<string, string> = {
  ...
  "payments.historical.title": "Historical collections",
  "payments.historical.collected": "Confirmed legacy collections",
  "payments.historical.review": "Amount requiring review",
  "payments.historical.appointments": "appointments",
  "payments.historical.readOnly": "Read-only legacy-system data, kept separate from current-system revenue and payments.",
