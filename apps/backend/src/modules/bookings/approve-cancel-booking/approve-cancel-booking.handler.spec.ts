...
describe('ApproveCancelBookingHandler', () => {
  it('approves cancel request and sets status to CANCELLED', async () => {
    ...
    const handler = new ApproveCancelBookingHandler(prisma as never, buildRlsTx(prisma) as never, eb as never, defaultSettings as never);
  ...
  it('throws NotFoundException when booking not found', async () => {
    ...
    const handler = new ApproveCancelBookingHandler(prisma as never, buildRlsTx(prisma) as never, buildEventBus() as never, defaultSettings as never);
  ...
  it('defaults autoRefund to true when setting not present', async () => {
    ...
    const handler = new ApproveCancelBookingHandler(prisma as never, buildRlsTx(prisma) as never, buildEventBus() as never, settingsNoRefund as never);
